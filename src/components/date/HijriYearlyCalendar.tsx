...
//   • Islamic event dots for Eid, Mawlid, etc.
          ...
          >
            ...
            >
              {Array.from({ length: firstDay }).map((_, i) => (
                <div key={`b-${i}`} style={{ minHeight: '40px' }} />
              ))}
              ...
              {Array.from({ length: days }, (_, i) => i + 1).map((day) => {
                ...
                return (
                  <Link
                    ...
                    style={{
                      minHeight:  '40px',
                      background: data?.hasEvent ? (special?.softBg ?? 'var(--success-soft)') : 'transparent',
                    }}
                    ...
                    {data?.hasEvent && (
                      <span
                        ...
                        style={{
                          ...
                          width: '5px',
                          height: '5px',
                          background: special?.color ?? 'var(--success)',
                        }}
                        aria-hidden="true"
                      />
                    )}
