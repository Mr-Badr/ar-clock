...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex min-h-[var(--space-11)] flex-1 items-center justify-center gap-[var(--space-2)] rounded-[calc(var(--radius-lg)-3px)] border border-transparent px-[var(--space-4)] py-[var(--space-2)] [font-size:var(--text-sm)] font-medium leading-[var(--leading-none)] whitespace-nowrap text-[var(--text-3)] transition-[background-color,border-color,box-shadow,color,transform] duration-100 hover:text-[var(--text-1)] focus-visible:border-[var(--border-focus)] focus-visible:shadow-[var(--shadow-focus)] disabled:pointer-events-none disabled:opacity-50 group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-[var(--space-4)]",
