...
export const CALC_CATEGORIES: CalcCategory[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        label: "العدة الشرعية",
        desc: "للأرملة والمطلقة والحامل بالهجري",
        icon: Moon,
      },
      {
        href: "/calculators/aqiqah",
        label: "حاسبة العقيقة",
        desc: "عدد الذبائح والتكلفة التقديرية للمولود",
        icon: Baby,
      },
      {
        href: "/calculators/wasiyya",
        label: "الوصية الشرعية",
        desc: "كم يجوز أن توصي من تركتك (حد الثلث)",
        icon: Scales,
      },
      {
        href: "/calculators/nafaqah",
        label: "تقدير النفقة",
        desc: "نطاق تقديري لنفقة الزوجة والأولاد",
        icon: Scales,
      },
      {
        href: "/calculators/domestic-worker-cost",
        label: "تكلفة استقدام عاملة",
        desc: "رسوم مساند الحكومية + راتبها ومكتب الاستقدام",
        icon: IdentificationCard,
      },
      {
      ...
      },
      {
        ...
        desc: "رصيدك وقيمتها المالية بالراتب",
        icon: CalendarDots,
      },
      {
        href: "/calculators/sick-leave",
        label: "الإجازة المرضية",
        desc: "راتبك أثناء المرض وفق المادة 117",
        icon: FirstAidKit,
      },
      {
        href: "/calculators/working-days",
        label: "أيام العمل بين تاريخين",
        desc: "عطلة نهاية الأسبوع الصحيحة لكل دولة",
        icon: Briefcase,
      },
      {
        href: "/calculators/margin-markup",
        label: "هامش الربح والزيادة",
        desc: "Margin و Markup بالاتجاهين",
        icon: TrendUp,
      },
    ],
  },
  {
    ...
    viewAll: "/calculators/personal-finance",
    tools: [
      {
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        label: "حاسبة البلاط",
        desc: "عدد كراتين البلاط والسيراميك",
        icon: SquaresFour,
      },
      {
        href: "/calculators/building/paint",
        label: "حاسبة الدهان",
        desc: "لترات الدهان المطلوبة للغرفة",
        icon: PaintBucket,
      },
    ],
  },
