  ...
  return (
    <div className="economy-stack">
      <EconomyHero
        ...
        title="هل السوق الأمريكي أو الذهب مفتوح الآن؟ أدوات اقتصادية تجيب فوراً"
        lead="هذا القسم يبني أدوات يومية قابلة للبحث في العالم العربي من دون أي اشتراك مدفوع: متى يفتح السوق الأمريكي، هل الذهب مفتوح الآن، متى تبدأ جلسة لندن ونيويورك، وأين السيولة الأعلى الآن. الفكرة الأساسية بسيطة: نحول الجداول العالمية إلى جواب مباشر بتوقيت المستخدم نفسه."
        metaPills={[
      ...
      <AdTopBanner slotId="top-economy-landing" />
        ...
        model={{
          eyebrow: 'منهج القسم',
          title: 'اقتصاد يومي بصياغة عربية يبحث بها الناس فعلاً',
