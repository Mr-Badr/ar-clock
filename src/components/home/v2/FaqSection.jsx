...
export const FAQ_ITEMS = [
  {
    q: 'ما هو موقع ميقاتنا؟',
    a: 'ميقاتنا (بالإنجليزية: Miqatona) منصة عربية مجانية على miqatona.com تجمع في مكان واحد أدوات وحاسبات عملية لعشرات المجالات، ومواعيد المناسبات والأعياد بعدّ تنازلي، والوقت والتاريخ الهجري والميلادي لأي مدينة. اسم "ميقاتنا" مشتق من "ميقات" أي الوقت أو الموعد المحدد.',
  },
  {
