...
export const metadata = buildCanonicalMetadata({
  title: 'من نحن',
  description:
    'تعرف على مشروع ميقات، رؤيته، وكيف بُني كمنصة عربية مستقلة للوقت والمواعيد والمناسبات مع تركيز قوي على الدقة والـ SEO.',
  keywords: [
    'من نحن ميقات',
    'عن موقع ميقات',
    'منصة عربية للوقت',
...
export default function AboutPage() {
  const schema = {
    ...
    inLanguage: 'ar',
    description:
      'صفحة تعريفية بمشروع ميقات، وهو موقع عربي مستقل يركز على الوقت، التواريخ، والمناسبات بصفحات سريعة ومهيأة لمحركات البحث.',
    publisher: {
      '@type': 'Organization',
      name: SITE_BRAND,
      url: SITE_URL,
