...
export const metadata = buildCanonicalMetadata({
  title: 'مواقيت الصلاة اليوم في مدينتك | الفجر والمغرب والصلاة القادمة',
  description:
    'اعرف مواقيت الصلاة اليوم في مدينتك للفجر والظهر والعصر والمغرب والعشاء، مع الصلاة القادمة والجدول الشهري وطريقة الحساب والمذهب ووقت الإمساك والإفطار.',
