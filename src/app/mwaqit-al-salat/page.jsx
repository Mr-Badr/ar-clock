...
export const metadata = buildCanonicalMetadata({
  ...
  description:
    'إذا كان سؤالك: متى أذان الفجر والمغرب اليوم في مدينتك؟ فهذه الصفحة تعرض مواقيت الصلاة الدقيقة للفجر والشروق والظهر والعصر والمغرب والعشاء، مع الصلاة القادمة وإمساكية شهرية وطريقة الحساب المناسبة لكل بلد.',
    ...
    <>
      ...
      <section className="card mb-10" aria-labelledby="popular-prayer-city-links-heading">
        ...
        <p className="text-sm text-secondary leading-[1.8] mb-5">
          إذا كنت تبحث عن مواقيت الصلاة في مدينة مشهورة مثل الرياض أو الرباط أو
          القاهرة، فهذه الروابط تختصر عليك الطريق إلى الصفحات الأكثر زيارة.
        </p>
        <div
          style={{
            display: 'grid',
      ...
      <section className="card-nested mb-12" aria-labelledby="popular-prayer-country-links-heading">
        ...
        <p className="text-sm text-secondary leading-[1.8] mb-4">
          انتقل من صفحة الدولة إلى المدن التابعة لها بسرعة، واختر المدينة التي تريد
          متابعة مواقيتها من دون بحث إضافي.
        </p>
        <div className="flex flex-wrap gap-2">
      ...
      <main className="content-col pt-24 pb-20 mt-12">
        ...
        <section className="mb-12">
          <GeoInternalLinks
            ...
            description="قد تحتاج مع مواقيت الصلاة إلى الوقت الآن أو تاريخ اليوم أو فرق التوقيت، لذلك جمعنا لك هذه الروابط الأساسية في مكان واحد."
            links={utilityLinks}
