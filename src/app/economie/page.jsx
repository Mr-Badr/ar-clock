...
export const metadata = buildCanonicalMetadata({
  title: 'الاقتصاد الحي | السوق الأمريكي والذهب وجلسات الفوركس',
  description:
    `قسم اقتصادي مجاني داخل ${SITE_BRAND} يقدّم أدوات يومية بالعربية: متى يفتح السوق الأمريكي، هل الذهب مفتوح الآن، جلسات الفوركس، والبورصات العالمية بتوقيت المستخدم المحلي.`,
  keywords: [
