...
export default function ZakatPage() {
  ...
  return (
    <main className="calc-product-page calc-zakat-page bg-base text-primary" dir="rtl" lang="ar">
        ...
        <CalculatorInfoGrid
          items={[
            ...
            },
            {
              ...
              content: 'البضاعة المعدة للبيع (مخزون تجاري) تُزكّى بالقيمة السوقية الحالية (سعر البيع) يوم وجوب الزكاة — وليس بسعر الشراء، وهو قول جمهور الفقهاء. الديون المستحقة لك من آخرين (القابلة للتحصيل) تدخل في الوعاء. أما ديونك أنت قصيرة الأجل فتُطرح من الوعاء عند جمهور المالكية والشافعية والحنابلة؛ بينما فصّل الحنفية بين ديون العباد وديون الله.',
            },
          ]}
        />
      </CalculatorSection>
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>نعم</TableCell>
                <TableCell>القيمة السوقية الحالية (سعر البيع)</TableCell>
                <TableCell>2.5%</TableCell>
                <TableCell>في نهاية الحول بعد طرح الديون — لا تُقوَّم بسعر الشراء</TableCell>
              </TableRow>
              <TableRow>
      ...
      <CalculatorSection
        id="zakat-madhahib"
        eyebrow="اختلاف الفقهاء"
        title="أين تختلف المذاهب الأربعة في حساب الزكاة؟ ولماذا اخترنا هذا الافتراضي"
        description="معظم أحكام الزكاة متفق عليها. الحاسبة تعتمد رأي الجمهور في نقاط الخلاف القليلة، وتوضّح لك البديل حتى تختار بنفسك إن رغبت."
        subtle
      >
        <CalculatorInfoGrid
          items={[
            {
              title: 'حسم الديون من الوعاء الزكوي',
              description: 'المالكية والشافعية والحنابلة مقابل الحنفية',
              content: 'جمهور الفقهاء (المالكية والشافعية والحنابلة) يرون أن الدين يمنع وجوب الزكاة في الأموال الباطنة كالنقود وعروض التجارة، فتُخصم ديونك قصيرة الأجل قبل حساب النصاب — وهذا ما تعتمده هذه الحاسبة. الحنفية يفرّقون بين ديون العباد (تُخصم) وديون الله كالنذور والكفارات (لا تمنع الوجوب). وذهب بعض الشافعية وابن حزم إلى أن الدين لا يمنع الزكاة إن كان بيدك نصاب فأكثر.',
            },
            {
              title: 'تقويم البضاعة التجارية',
              description: 'اتفاق عام مع تفصيلات يسيرة',
              content: 'المذاهب الأربعة متفقة على أن عروض التجارة تُزكّى بقيمتها، لا بأعيانها. الراجح المعتمد في هذه الحاسبة: القيمة السوقية الحالية (سعر البيع) يوم وجوب الزكاة — وليس بسعر الشراء الأصلي. هذا يعني أن بضاعة اشتريتها بمبلغ ثم ارتفع سعرها في السوق، تُزكّى بسعرها الحالي الأعلى.',
            },
            {
              title: 'نصاب النقود: معيار الذهب أم الفضة',
              description: 'مجمع الفقه الإسلامي يرجّح الأحظ للفقراء',
              content: 'قرار مجمع الفقه الإسلامي (رابطة العالم الإسلامي) ينص على وجوب زكاة الأوراق النقدية إذا بلغت أدنى النصابين — أي نصاب الفضة عملياً، لأنه أرخص من الذهب حالياً فيشمل عدداً أكبر ممن تلزمهم الزكاة. جهات زكاة رسمية أخرى قد تستخدم معيار الذهب في بعض تطبيقاتها. الحاسبة تتيح لك التبديل بين الأساسين بحرية.',
            },
          ]}
        />
      </CalculatorSection>
