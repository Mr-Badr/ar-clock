...
const FINANCE_TOOL_LABELS = {
  ...
  'eos-egypt':              'نهاية الخدمة مصر',
  'egypt-income-tax':       'ضريبة الدخل مصر',
  'egypt-social-insurance': 'تأمينات مصر',
  'eos-jordan':             'نهاية الخدمة الأردن',
  'morocco-net-salary':     'الراتب الصافي المغرب',
  'uae-corporate-tax':      'ضريبة شركات الإمارات',
  'bill-splitter':          'تقسيم الفاتورة',
  'work-hours':             'ساعات العمل الأسبوعية',
...
const FINANCE_TOOL_CTAS = {
  ...
  'eos-egypt':              'احسب مستحقات مصر',
  'egypt-income-tax':       'احسب ضريبتك الآن',
  'egypt-social-insurance': 'احسب اشتراكك',
  'eos-jordan':             'احسب مستحقات الأردن',
  'morocco-net-salary':     'احسب راتبك الصافي',
  'uae-corporate-tax':      'احسب ضريبة شركتك',
  'bill-splitter':          'قسّم الفاتورة الآن',
  'work-hours':             'احسب ساعات دوامك',
...
const FINANCE_TOOL_ICONS = {
  ...
  'eos-bahrain': 'البحرين',
  'eos-egypt':              'مصر',
  'egypt-income-tax':       'ضريبة',
  'egypt-social-insurance': 'تأمينات',
  'eos-jordan':             'الأردن',
  'morocco-net-salary':     'المغرب',
  'uae-corporate-tax':      'الإمارات',
  'bill-splitter':          'مجاني',
  'work-hours':             'يومي',
  vat: 'ضريبة',
  percentage: 'نسبة',
