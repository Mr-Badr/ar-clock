      ...
      >
        <div className="calc-editorial">
          <p>
            ...
            من دولة إلى أخرى. جميع الدول تضمن تعويضاً لا يقل عن 125–150% للساعة الإضافية،
            ويرتفع في أيام الراحة والعطل الرسمية إلى 150–200%.
          </p>
        </div>
        <div className="calc-info-table-wrap">
          <table className="calc-info-table">
            ...
            <tbody>
              {[
                ['sa', 'السعودية', '40 ساعة',  'ج–س',   '150%', '200%'],
                ['ae', 'الإمارات',  '48 ساعة',  'ج–س',   '125%', '150%+'],
                ['kw', 'الكويت',    '48 ساعة',  'ج–س',   '125%', '150%'],
                ['qa', 'قطر',       '48 ساعة',  'ج–س',   '125%', '150%'],
                ['bh', 'البحرين',   '48 ساعة',  'ج–س',   '125%', '150%'],
                ['eg', 'مصر',       '48 ساعة',  'ج–أ',   '135%', '200%'],
                ['ma', 'المغرب',    '44 ساعة',  'أ',    '125%', '150%'],
                ['jo', 'الأردن',    '48 ساعة',  'ج–أ',   '125%', '150%'],
              ].map(([code, c, h, w, ot, hol]) => (
                <tr key={code}>
                  <td><CountryFlag code={code} /> {c}</td>
