...
export const metadata = buildCanonicalMetadata({
  title: 'أكثر الحاسبات العربية بحثاً: العمر، القسط، الضريبة ونهاية الخدمة',
  description:
    'ابدأ من أكثر الحاسبات التي يبحث عنها المستخدم العربي يومياً: كم عمري الآن، كم قسط القرض، كم الضريبة 15%، وكم مكافأة نهاية الخدمة، مع نتائج فورية وشرح عربي واضح.',
...
export default function CalculatorsPage() {
  ...
  return (
    <main className="bg-base text-primary">
      ...
      <CalculatorHero
        badge="قسم الحاسبات"
        title="ابدأ من أكثر الحاسبات العربية بحثاً: العمر، القسط، الضريبة، ونهاية الخدمة"
        description="يغطي هذا القسم أهم الأدوات العملية التي يبحث عنها المستخدم العربي يومياً: حاسبة العمر، مستحقات نهاية الخدمة، القسط الشهري، ضريبة القيمة المضافة، النسبة المئوية، وتكلفة البناء. كل صفحة تجمع بين الحاسبة والشرح والأسئلة الشائعة وروابط واضحة لأدوات مرتبطة."
        accent="#2563EB"
        highlights={[
