...
const SAUDI_PAY_SCHEDULE = [
  ...
  {
    type: 'تعويض ساند (التأمين ضد التعطل)',
    emoji: '🧮',
    day: 'يوم 1 تقريباً',
    rule: 'ميلادي — خلال الأسبوع الأول من الشهر',
    authority: 'المؤسسة العامة للتأمينات الاجتماعية GOSI',
    slug: 'sand-payment-saudi',
    label: 'عد تنازلي لتعويض ساند',
    note: 'لمن فقد عمله بشكل غير اختياري وكان مشتركاً في GOSI',
  },
  {
    type: 'دعم ريف (التنمية الريفية)',
    emoji: '🌾',
    day: 'يوم 1 – 10',
    rule: 'ميلادي — يُصرف خلال العشرة الأيام الأولى',
    authority: 'وزارة البيئة والمياه والزراعة',
    slug: 'reef-support-saudi',
    label: 'عد تنازلي لدعم ريف',
    note: 'لصغار المنتجين الزراعيين والأسر المنتجة',
  },
  {
    type: 'مكافأة الجامعة',
    emoji: '🎓',
    day: 'يوم 27 (الأشيع)',
    rule: 'ميلادي — يختلف الموعد الفعلي بين الجامعات',
    authority: 'الجامعات السعودية / وزارة التعليم',
    slug: 'university-stipend-saudi',
    label: 'عد تنازلي لمكافأة الجامعة',
    note: 'للطلاب والطالبات المنتظمين — راجع إعلان جامعتك',
  },
];
