...
export const metadata = buildCanonicalMetadata({
  ...
  description:
    'الوقت الآن في أي مدينة أو دولة بالثانية — الرياض، القاهرة، دبي، لندن، نيويورك وأكثر من 100 مدينة. يشمل التاريخ المحلي والمنطقة الزمنية وفرق التوقيت وأوقات الصلاة.',
