      ...
      <main className="container" style={{ paddingTop: 'var(--space-24)', paddingBottom: 'var(--space-16)' }}>
        ...
        <div style={{ display: 'grid', gap: 'var(--space-6)' }}>
          ...
          <PolicySection title="3. خدمات الطرف الثالث">
            ...
            <p>
              إذا تغيرت الخدمات المستخدمة أو فُعّلت تحليلات أو وحدات إعلانية بشكل أوسع في المستقبل،
              فسيتم تحديث هذه الصفحة لتعكس ذلك بوضوح.
            </p>
          </PolicySection>
          ...
          <PolicySection title="4. ما الذي لا نقوم به حالياً">
            ...
            <p>
              وإن لاحظت أي نص قانوني هنا لا يطابق السلوك الفعلي للموقع، فهذا يعني أننا بحاجة إلى
              تحديث الوثيقة، ويمكنك الإبلاغ مباشرة عبر البريد التالي:
              {' '}
          ...
          <PolicySection title="5. التواصل وطلبات التصحيح">
            ...
            <p>آخر تحديث لهذه الصفحة: 31 مارس 2026.</p>
          </PolicySection>
        </div>
      </main>
    </div>
