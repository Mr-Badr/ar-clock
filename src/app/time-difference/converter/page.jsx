...
export const metadata = buildCanonicalMetadata({
  title: 'محوّل المناطق الزمنية — قارن 2 إلى 4 مدن بالتزامن | ميقاتنا',
  description:
    'أداة تفاعلية لمقارنة الوقت في 2–4 مدن عربية وعالمية دفعةً واحدة. حرّك شريط الوقت لمعرفة ساعات الدوام المشتركة وأفضل وقت للاتصال أو الاجتماع.',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'كيف تحتسب الأداة التوقيت الصيفي (DST)؟',
      acceptedAnswer: { '@type': 'Answer', text: 'تعتمد الأداة على واجهة Intl.DateTimeFormat المضمّنة في المتصفح، وهي تقرأ قواعد التوقيت الصيفي لكل منطقة زمنية IANA تلقائياً بحسب التاريخ الحالي.' },
    },
    {
      '@type': 'Question',
      name: 'ما الفرق بين هذه الأداة وصفحة فرق التوقيت؟',
      acceptedAnswer: { '@type': 'Answer', text: 'المحوّل يتيح رؤية 2–4 مدن في لقطة واحدة وهو أنسب للمقارنة السريعة قبل الاتصال. صفحة فرق التوقيت تركّز على مدينتين بالتفصيل مع جدول تحويل شامل.' },
    },
    {
      '@type': 'Question',
      name: 'هل يمكنني مقارنة مدن لا تقع في العالم العربي؟',
      acceptedAnswer: { '@type': 'Answer', text: 'نعم. القائمة تشمل مدناً أوروبية وأمريكية وأسترالية إلى جانب المدن العربية.' },
    },
    {
      '@type': 'Question',
      name: 'ما الفرق بين GMT وUTC وتوقيت المنطقة الزمنية؟',
      acceptedAnswer: { '@type': 'Answer', text: 'UTC هو معيار الوقت الأساسي. GMT يساوي UTC من الناحية العملية. توقيت المنطقة الزمنية كـUTC+3 هو فارق عن هذا المعيار، وقد يتغير مع التوقيت الصيفي.' },
    },
  ],
};
...
const toolSchema = {
  ...
  url: `${SITE_URL}/time-difference/converter`,
  description: 'قارن الوقت في 2–4 مدن عربية وعالمية بالتزامن. يحتسب التوقيت الصيفي تلقائياً.',
...
const USAGE_TIPS = [
  ...
  {
    title: 'للعمل عن بُعد',
    body: 'إذا كان فريقك موزعاً بين الرياض ولندن وتورنتو، أضف المدن الثلاث واضبط شريط الوقت لإيجاد فترة التداخل التي يكون فيها الجميع في ساعات العمل الرسمية. هذا يجنّبك إزعاج الزملاء خارج أوقات دوامهم.',
  },
];
        ...
        <div className="container">
          ...
          <header style={{ paddingBlock: 'var(--space-8) var(--space-4)' }}>
            ...
            <p style={{ fontSize: '1.05rem', color: 'var(--text-muted)', maxWidth: '55ch', lineHeight: 1.7 }}>
              ...
              الأداة تحتسب التوقيت الصيفي تلقائياً، فلا حاجة لحسابات يدوية عند تغيّر الساعة في أوروبا أو أمريكا.
              الخلايا الخضراء تمثّل ساعات الدوام الرسمي (9–17)، والرمادية تمثّل فترة الليل، لتجد بسرعة النافذة المشتركة بين مدن فريقك.
            </p>
          </header>
            ...
            <dl style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              {[
                ...
                },
                {
                  ...
                  a: 'صفحة فرق التوقيت تركّز على مدينتين بالتفصيل مع جدول تحويل شامل وساعة حية. أما المحوّل هنا فيتيح رؤية 2–4 مدن في لقطة واحدة، وهو أنسب للمقارنة السريعة قبل الاتصال أو تحديد موعد اجتماع.',
                },
                {
                ...
                {
                  q: 'ما الفرق بين GMT وUTC وتوقيت المنطقة الزمنية؟',
                  a: 'UTC (التوقيت العالمي المنسّق) هو معيار الوقت الأساسي الذي لا يتأثر بالتوقيت الصيفي. GMT (توقيت غرينيتش) يساوي UTC من الناحية العملية. أما توقيت المنطقة الزمنية كـ"UTC+3" فهو فارق ثابت أو متغير (في حالة DST) عن هذا المعيار. جميع المدن في المحوّل تُعرض بصيغة GMT+X لسهولة القراءة.',
                },
              ].map(({ q, a }) => (
                <div key={q}>
