...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: 'المحوّل يتيح رؤية ٢–٤ مدن في لقطة واحدة وهو أنسب للمقارنة السريعة قبل الاتصال. صفحة فرق التوقيت تركّز على مدينتين بالتفصيل مع جدول تحويل شامل.' },
    },
    {
      '@type': 'Question',
        ...
        <div className="container">
          ...
          <header style={{ paddingBlock: 'var(--space-8) var(--space-4)' }}>
            ...
            <p style={{ fontSize: '1.05rem', color: 'var(--text-muted)', maxWidth: '55ch', lineHeight: 1.7 }}>
              ...
              الخلايا الخضراء تمثّل ساعات الدوام الرسمي (٩–١٧)، والرمادية تمثّل فترة الليل، لتجد بسرعة النافذة المشتركة بين مدن فريقك.
            </p>
          </header>
