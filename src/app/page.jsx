        ...
        <section className="container mx-auto px-4 py-16 border-t border-[var(--border-subtle)]">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none text-muted leading-loose space-y-4">
              ...
              <p>
                تسعى "ساعة عربية" لتكون الوجهة الأولى لكل من يتساءل عن <strong>توقيت مصر الآن</strong> أو <strong>مواقيت الصلاة في المغرب</strong> أو <strong>الساعة في السعودية</strong>. نظامنا يدعم تتبع الوقت لآلاف المدن وتوفير معلومات المنطقة الزمنية (Timezone) بدقة متناهية.
              </p>
            </div>
            ...
            <div className="sr-only" aria-hidden="true">
              ...
              <ul>
                <li>توقيت القاهرة الآن، مواقيت الصلاة في الرياض، أذان الفجر مكة المكرمة</li>
                <li>الوقت الحالي في دبي، ساعة المغرب الآن، توقيت الجزائر العاصمة</li>
                ...
                <li>فرق التوقيت بين الدول، توقيت غرينتش الآن، المناطق الزمنية العالمية</li>
