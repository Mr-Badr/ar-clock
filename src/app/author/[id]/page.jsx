      ...
      <div className="max-w-3xl mx-auto px-4 py-16 sm:py-24">
        ...
        <section aria-labelledby="author-method-heading" className="mb-10">
          ...
          <div className="space-y-3 text-base leading-relaxed text-secondary">
            ...
            <p>
              أدوات الوقت وحسابات إمساكية رمضان تعتمد على حزمة Adhan الحسابية المُشار إليها في الأدبيات العلمية، مع بيانات مناطق زمنية محدّثة من قاعدة IANA tzdata. أدوات التقويم الهجري تعتمد معيار أم القرى المعمول به رسمياً في المملكة العربية السعودية، مع إشارة صريحة عند وجود اختلافات بين الدول.
            </p>
            <p>
