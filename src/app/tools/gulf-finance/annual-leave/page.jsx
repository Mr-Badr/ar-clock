import AnnualLeaveTool from '@/components/calculators/gulf-finance/AnnualLeaveTool.client';
...
const TOC_ITEMS = [
  ['leave-guide', 'كيف يُحسب رصيد الإجازة السنوية؟'],
  ['leave-faq', 'الأسئلة الشائعة'],
...
export default function AnnualLeavePage() {
  ...
  return (
    <main className="bg-base text-primary" dir="rtl" lang="ar">
      ...
      <ToolTopAdSlot slotId="top-annual-leave" />
      <TocDetailsReveal />
      ...
      <div className="container mx-auto px-4 tool-v2-lanes">
        ...
        <div className="tool-v2-lane-mobile-ad"><ToolInArticleAd slotId="mobile-annual-leave" /></div>

        <article className="tool-v2-lane-article">
          <section id="leave-guide">
            <h2>كيف يُحسب رصيد الإجازة السنوية؟</h2>
            <p>
              يُقسَّم إجمالي أيام الإجازة السنوية المستحقة على 12 شهراً، ثم يُضرب الناتج في عدد
              الأشهر الفعلية في الخدمة. مثال في السعودية: 30 يوم ÷ 12 = 2.5 يوم شهرياً. نظام العمل
              السعودي يمنح 21 يوماً في السنوات الخمس الأولى، ثم يرتفع إلى 30 يوماً بعد 5 سنوات خدمة
        ...
        <div className="tool-v2-lane-tool">
          <div className="tool-v2-tool-panel"><AnnualLeaveTool /></div>
        </div>
      </div>
    </main>
  );
