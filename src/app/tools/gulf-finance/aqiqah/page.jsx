import AqiqahTool from '@/components/calculators/gulf-finance/AqiqahTool.client';
...
const TOC_ITEMS = [
  ...
  ['aqiqah-faq', 'الأسئلة الشائعة'],
  ['aqiqah-sources', 'مصادر'],
];
...
export default function AqiqahPage() {
  ...
  return (
    <main className="bg-base text-primary" dir="rtl" lang="ar">
      ...
      <ToolTopAdSlot slotId="top-aqiqah" />
      <TocDetailsReveal />
      ...
      <div className="container mx-auto px-4 tool-v2-lanes">
        ...
        <div className="tool-v2-lane-mobile-ad"><ToolInArticleAd slotId="mobile-aqiqah" /></div>

        <article className="tool-v2-lane-article">
          <section id="aqiqah-guide">
            <h2>كم عدد الذبائح المطلوبة فعلياً؟</h2>
            <p>
              عن كل مولود ذكر شاتان، وعن كل مولود أنثى شاة واحدة — هذا هو الأساس الشرعي الثابت الذي
              تعتمده هذه الأداة (حديث عائشة رضي الله عنها، رواه الترمذي وأبو داود). التكلفة المعروضة
              أسعار سوق سعودية فعلية في غير موسم الأضحى (الأسعار في موسم عيد الأضحى قد ترتفع
        ...
        <div className="tool-v2-lane-tool">
          <div className="tool-v2-tool-panel"><AqiqahTool /></div>
        </div>
      </div>
    </main>
  );
