...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'الصيغة الهندسية الأساسية: وزن معدن اللحام (كجم) = طول اللحام × مساحة مقطع اللحام × كثافة المعدن. عملياً، أسهل طريقة هي استخدام معدل استهلاك تقريبي لكل نوع قطب لكل 100 متر لحام — أدخل طول اللحام الإجمالي ونوع القطب في الحاسبة أعلاه لتحصل على الوزن التقديري مباشرة، مع هامش أمان يُنصح بإضافته للهدر.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'القاعدة التقريبية الشائعة: التيار بالأمبير ≈ قطر القطب بالمليمتر × 40 — استخدمها كنقطة بداية في الحاسبة أعلاه ثم اضبط الرقم فعلياً حسب جودة اللحام الناتج على معدنك. مثال موثّق: قطب 3.2 مم من نوع E7018 يعمل عادة بين 75 و125 أمبير حسب عدد التمريرات ووضعية اللحام (أفقي، عمودي، فوق الرأس).',
  },
  {
