...
const FAQ_ITEMS = [
  {
    ...
    answer: 'الأمبير ليس وحدة قدرة مستقلة — يحتاج معرفة جهد الدائرة ومعامل القدرة. راجع المعادلة الكاملة (للدائرة الأحادية والثلاثية الطور) في قسم "العلاقة بين الواط والأمبير" أعلاه، أو استخدم أداة التحويل مباشرة لتفادي الخطأ.',
  },
  {
  ...
  },
  {
    ...
    answer: 'كيلو واط (kW) يقيس القدرة الفعلية المستهلكة، بينما كيلو فولت أمبير (kVA) يقيس القدرة الظاهرية الكلية في الدائرة — العلاقة بينهما موضحة في قسم "العلاقة بين الواط والأمبير" أعلاه. معامل القدرة يكون 1 للأحمال المقاومة البحتة (إضاءة، تسخين) وأقل من 1 (عادة 0.8-0.95) للمحركات والمكيفات.',
  },
  {
        ...
        <article className="tool-v2-lane-article">
          ...
          <section id="watts-amps">
            ...
            <p>
              ...
              مباشرة دون معرفة جهد الدائرة. لهذا فإن حساب "كم أمبير يحتاجه جهاز 1500 واط" يحتاج
              أولاً معرفة هل الدائرة أحادية الطور (230 فولت، الأشيع في المنازل) أو ثلاثية الطور
              (400 فولت، للأحمال الكبيرة).
            </p>
            <FormulaCard label="المعادلة الأساسية التي تربط الواط بالفولت والأمبير:">
              <span>واط = فولت × أمبير × معامل القدرة</span>
            </FormulaCard>
            <p>
            ...
            <FormulaCard
              label="لحساب الأمبير من الواط في دائرة أحادية الطور، اقلب المعادلة أعلاه:"
              note="للدائرة ثلاثية الطور، تُضرب الفولت في جذر 3 (≈1.732) قبل القسمة."
            >
              <span>أمبير =</span>
              <Frac num="واط" den="فولت × معامل القدرة" />
            </FormulaCard>
          </section>
