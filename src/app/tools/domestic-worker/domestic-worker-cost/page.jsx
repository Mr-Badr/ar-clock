...
import DomesticWorkerCostTool from '@/components/calculators/gulf-finance/DomesticWorkerCostTool.client';
...
const TOC_ITEMS = [
  ['dwc-guide', 'لماذا لا تحسب الأداة رسوم مكتب الاستقدام تلقائياً؟'],
  ['dwc-faq', 'الأسئلة الشائعة'],
  ['dwc-related', 'نفس الحاسبة في دول خليجية أخرى'],
];
...
const SIBLING_TOOLS = pickTools([
  'domestic-worker-cost-uae', 'domestic-worker-cost-kuwait', 'domestic-worker-cost-qatar',
...
export default function DomesticWorkerCostPage() {
  ...
  return (
    <main className="bg-base text-primary" dir="rtl" lang="ar">
      ...
      <ToolTopAdSlot slotId="top-dw-saudi" />
      <TocDetailsReveal />
      ...
      <div className="container mx-auto px-4 tool-v2-lanes">
        ...
        <div className="tool-v2-lane-mobile-ad"><ToolInArticleAd slotId="mobile-dw-saudi" /></div>

        <article className="tool-v2-lane-article">
          <section id="dwc-guide">
            <h2>لماذا لا تحسب الأداة رسوم مكتب الاستقدام تلقائياً؟</h2>
            <p>
              رسوم إصدار التأشيرة (حوالي 2,000 ريال) وخدمة منصة مساند الإلكترونية (حوالي 172.5 ريال)
              والإقامة السنوية (حوالي 600 ريال) والتأمين الصحي (حوالي 332 ريال سنوياً) أرقام حكومية
              ثابتة نسبياً ولا تعتمد على المكتب الذي تتعامل معه — الأداة تحسبها تلقائياً. أما رسوم
              مكتب الاستقدام نفسه فتختلف فعلياً بين المكاتب والجنسيات والمواسم، فتتركها الأداة حقلاً
              تُدخله من عرض السعر الفعلي الذي تلقيته.
            </p>
            <PlainBlock eyebrow="من يتحمل التكلفة؟" title="جميع الرسوم على صاحب العمل بالكامل">
              لا يجوز تحميل العاملة أي جزء من رسوم الاستقدام أو السفر أو الإقامة أو التأمين الصحي —
              هذا حق مكفول بنظام العمل السعودي، ولا يجوز خصمه من راتبها بأي شكل.
            </PlainBlock>
          </section>

          <ToolInArticleAd slotId="mid-dw-saudi" />
        ...
        <div className="tool-v2-lane-tool">
          <div className="tool-v2-tool-panel"><DomesticWorkerCostTool /></div>
        </div>
      </div>
    </main>
  );
