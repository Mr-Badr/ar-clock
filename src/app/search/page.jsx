...
const SEARCH_PAGE_DESCRIPTION =
  'استخدم البحث الداخلي في ميقاتنا للوصول إلى أدوات الوقت، التاريخ، الحاسبات، والمناسبات بصيغة سؤالك الطبيعي.';
...
const SEARCH_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'جرّب عبارة أقصر، احذف الكلمات العامة، أو اختر تبويب "الكل" لرؤية كل الأقسام. مثال: بدلاً من “أريد أداة تساعدني في حساب القرض” اكتب “حاسبة القسط”.',
  },
];
