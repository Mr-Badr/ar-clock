...
export const metadata: Metadata = {
  ...
  description: 'صفحة وضع عدم الاتصال في ميقاتنا: لماذا توقف التحميل، ماذا تفعل الآن، ومتى يجب إعادة تحميل الوقت والتاريخ والحاسبات بعد عودة الشبكة.',
  robots: {
    index: false,
    follow: false,
  },
...
export default function OfflinePage() {
  const recoverySteps = [
    ...
    },
    {
      ...
      description: 'الوقت الان، التاريخ الحالي، والحاسبات تحتاج اتصالاً حديثاً. انتظر عودة الشبكة قبل أن تبني عليها موعداً أو قراراً.',
    },
    {
      title: 'ارجع إلى المسار الصحيح بعد الاتصال',
      description: 'إذا كنت تعرف سؤالك، افتح مركز التاريخ أو الوقت الان مباشرة.',
    },
  ];

  const safeOfflineChecks = [
    'إذا كان السؤال عن موعد أو تاريخ اليوم أو نتيجة حاسبة، أعد التحميل بعد عودة الشبكة.',
  ...
  const offlineFacts = [
    ...
    },
    {
      ...
      description: 'الساعة وفروق التوقيت قد تتغير أو تعتمد على موقعك. عرض قيمة قديمة قد يكون أسوأ من إيقاف التجربة.',
    },
    {
  ...
  const availablePaths = [
    ...
    },
    {
      href: '/tools',
      title: 'الأدوات',
      description: 'حاسبات ومحوّلات عربية لكل مجال، من مكان واحد.',
      icon: Search,
    },
  ];
        ...
        >
          <div>
            ...
            <p className="text-sm text-secondary leading-relaxed mb-3">
              بعض صفحات ميقاتنا تعتمد على بيانات حية أو شبه حية، مثل الوقت الان، فرق التوقيت، والتحويلات المرتبطة بتاريخ اليوم. عرض نتيجة قديمة في هذه الحالات قد يربكك أكثر مما يساعدك، لذلك نفضّل إيقاف التجربة مؤقتاً مع رسالة واضحة بدلاً من تقديم معلومة غير مؤكدة.
            </p>
            <p className="text-sm text-secondary leading-relaxed m-0">
              هدف وضع عدم الاتصال ليس إبقاءك داخل الموقع بأي ثمن، بل توضيح ما حدث وما القرار الصحيح بعده. عند عودة الاتصال يمكنك إعادة تحميل الصفحة نفسها، أو الانتقال إلى مركز التاريخ للوصول إلى الأداة المطلوبة بسرعة.
            </p>
          </div>
