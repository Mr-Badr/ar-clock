...
const TOOL_CARDS = [
  ...
  },
  {
    ...
    eyebrow: 'مباشر الآن',
    body: 'اعرف متى تبدأ جلسة لندن ونيويورك اليوم، وهل سوق الفوركس مفتوح الآن، وأين تقع نافذة السيولة الأعلى للأزواج الرئيسية والذهب.',
    tone: 'success',
    isLive: true,
  },
  {
    ...
    eyebrow: 'مباشر الآن',
    body: 'تحقق من حالة أمريكا ولندن وتداول السعودي اليوم من مدينتك، مع الافتتاح والإغلاق والجلسات الموسعة في صفحة واحدة.',
    tone: 'warning',
    isLive: true,
  },
  {
    ...
    eyebrow: 'أداة جديدة',
    body: 'ساعة سوق بصرية تكشف أين ترتفع السيولة الآن داخل يومك المحلي بدلاً من تفكيك أربع جداول منفصلة.',
    tone: 'brand',
    isLive: true,
  },
  {
    ...
    eyebrow: 'أداة جديدة',
    body: 'اعرف أفضل نافذة اليوم لتداول الفوركس والذهب من مدينتك، مع نوافذ السيولة الأعلى وجدول أسبوعي عملي.',
    tone: 'info',
    isLive: true,
  },
];
...
export function buildMarketClockPageModel(viewer, nowInput = ECONOMY_FALLBACK_NOW_ISO) {
  ...
  return {
    ...base,
    heroTitle: `أين السيولة الأعلى الآن من ${base.viewer.label}؟`,
    heroLead:
      'هذه الصفحة تجيب عن سؤال عملي مباشر: أين تكون السيولة الأعلى الآن داخل يومك المحلي؟ نعرض السوق كساعة بصرية تبدأ من آسيا وتصل إلى ذروة لندن ونيويورك، حتى ترى نافذة النشاط فوراً بدلاً من قراءة أربع جداول منفصلة.',
    browserTitle: `أين السيولة الأعلى الآن؟ | ساعة السوق — ${SITE_BRAND}`,
...
export function buildBestTradingTimePageModel(viewer, nowInput = ECONOMY_FALLBACK_NOW_ISO) {
  ...
  return {
    ...base,
    heroTitle: `ما أفضل وقت للتداول اليوم من ${base.viewer.label}؟`,
    heroLead:
      'بدلاً من سؤال عام مثل "متى أتابع السوق؟"، تعطيك هذه الصفحة جواباً عربياً مباشراً من مدينتك نفسها: ما أفضل وقت للتداول اليوم، متى تبدأ لندن، متى يدخل الدولار بقوة، ومتى تصبح متابعة الذهب أكثر جدوى. لكنها تظل أداة مساعدة للتنظيم والفهم، لا بديلاً عن قرارك الشخصي أو تحققك من السوق الفعلي.',
    helpSections: [
      {
