...
export const GPA_SYSTEMS = {
  scale5: {
    ...
    classifications: [
      { min: 4.75, max: 5,    label: 'ممتاز',     labelEn: 'Excellent',   level: 'excellent', color: '#16a34a' },
      { min: 3.75, max: 4.74, label: 'جيد جداً',  labelEn: 'Very Good',   level: 'very-good', color: '#2563eb' },
      { min: 2.75, max: 3.74, label: 'جيد',        labelEn: 'Good',        level: 'good',      color: '#d97706' },
      { min: 2.00, max: 2.74, label: 'مقبول',      labelEn: 'Pass',        level: 'pass',      color: '#ea580c' },
      { min: 0,    max: 1.99, label: 'راسب',       labelEn: 'Fail',        level: 'fail',      color: '#dc2626' },
    ],
  },
  scale4: {
    id: 'scale4',
    ...
    classifications: [
      { min: 3.67, max: 4.0,  label: 'ممتاز',     labelEn: 'Summa Cum Laude', level: 'excellent', color: '#16a34a' },
      { min: 3.33, max: 3.66, label: 'جيد جداً',  labelEn: 'Magna Cum Laude', level: 'very-good', color: '#2563eb' },
      { min: 3.00, max: 3.32, label: 'جيد',        labelEn: 'Cum Laude',       level: 'good',      color: '#d97706' },
      { min: 2.00, max: 2.99, label: 'مقبول',      labelEn: 'Pass',            level: 'pass',      color: '#ea580c' },
      { min: 0,    max: 1.99, label: 'راسب',       labelEn: 'Fail',            level: 'fail',      color: '#dc2626' },
    ],
  },
  scale100: {
    ...
    grades: [],
    classifications: [
      { min: 90,  max: 100, label: 'ممتاز',    labelEn: 'Excellent',  level: 'excellent', color: '#16a34a' },
      { min: 80,  max: 89,  label: 'جيد جداً', labelEn: 'Very Good',  level: 'very-good', color: '#2563eb' },
      { min: 70,  max: 79,  label: 'جيد',       labelEn: 'Good',       level: 'good',      color: '#d97706' },
      { min: 60,  max: 69,  label: 'مقبول',     labelEn: 'Pass',       level: 'pass',      color: '#ea580c' },
      { min: 0,   max: 59,  label: 'راسب',      labelEn: 'Fail',       level: 'fail',      color: '#dc2626' },
    ],
  },
  scale20: {
    id: 'scale20',
    ...
    grades: [],
    classifications: [
      { min: 16,  max: 20,    label: 'ممتاز',    labelEn: 'Très Bien',   level: 'excellent', color: '#16a34a' },
      { min: 14,  max: 15.99, label: 'جيد جداً', labelEn: 'Bien',        level: 'very-good', color: '#2563eb' },
      { min: 12,  max: 13.99, label: 'جيد',       labelEn: 'Assez Bien',  level: 'good',      color: '#d97706' },
      { min: 10,  max: 11.99, label: 'مقبول',     labelEn: 'Passable',    level: 'pass',      color: '#ea580c' },
      { min: 0,   max: 9.99,  label: 'راسب',      labelEn: 'Insuffisant', level: 'fail',      color: '#dc2626' },
    ],
  },
  scale10: {
    id: 'scale10',
    ...
    grades: [],
    classifications: [
      { min: 8,  max: 10,   label: 'ممتاز',    labelEn: 'Très Bien',   level: 'excellent', color: '#16a34a' },
      { min: 7,  max: 7.99, label: 'جيد جداً', labelEn: 'Bien',        level: 'very-good', color: '#2563eb' },
      { min: 6,  max: 6.99, label: 'جيد',       labelEn: 'Assez Bien',  level: 'good',      color: '#d97706' },
      { min: 5,  max: 5.99, label: 'مقبول',     labelEn: 'Passable',    level: 'pass',      color: '#ea580c' },
      { min: 0,  max: 4.99, label: 'راسب',      labelEn: 'Insuffisant', level: 'fail',      color: '#dc2626' },
    ],
  },
};
