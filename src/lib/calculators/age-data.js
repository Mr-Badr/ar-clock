export const AGE_ROUTE = {
  ...
  description:
    'قسم عربي متكامل لمن يبحث عن حاسبة العمر: احسب عمرك الآن، عمرك بالهجري والميلادي، فرق العمر، يوم الميلاد، الإنجازات الزمنية، وعدّاد عيد الميلاد.',
  accent: '#EA580C',
...
export const AGE_CALCULATOR_ROUTES = [
  ...
  },
  {
    ...
    description: 'اعرف عمرك بالهجري أو حوّل العمر بين الميلادي والهجري مع شرح الفرق بين التقويمين.',
    accent: '#0F766E',
  },
  {
    slug: 'difference',
  ...
  },
  {
    ...
    description: 'اكتشف متى تكمل 10,000 يوم أو مليار ثانية مع خط زمني واضح لما تجاوزته وما ينتظرك.',
    accent: '#7C3AED',
  },
  {
    slug: 'planets',
