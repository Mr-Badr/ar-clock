...
export const RELIGIOUS_HOLIDAYS = [
  {
    ...
    faqItems: [
      { q: 'كم باقي على رمضان 2027؟', a: 'يبدأ رمضان 1448 في فبراير 2027 وفق أم القرى. قد يختلف بيوم في الدول ذات رؤية الهلال المحلية.' },
      { q: 'كم يوم رمضان 2027؟', a: 'شهر رمضان إما 29 أو 30 يوماً بحسب رؤية هلال شوال.' },
      { q: 'متى ليلة القدر في رمضان 2027؟', a: 'أرجح لياليها ليلة 27 رمضان الموافقة تقريباً في مارس 2027.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على عيد الفطر 2026؟', a: '20 مارس 2026 وفق أم القرى — قد يختلف بيوم في دول الرؤية المحلية.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على عيد الأضحى 2026؟', a: '27 مايو 2026 وفق أم القرى.' },
      { q: 'كم باقي على يوم عرفة 2026؟', a: '26 مايو 2026 — اليوم التاسع من ذي الحجة.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على يوم عرفة 2026؟', a: '26 مايو 2026 — اليوم التاسع من ذي الحجة 1447.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على موسم الحج 2026؟', a: 'يبدأ يوم 8 ذو الحجة 1447 الموافق 25 مايو 2026.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على رأس السنة الهجرية 1448؟', a: '16 يونيو 2026م.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على عاشوراء 2026؟', a: '25 يونيو 2026م — 10 محرم 1448 هـ.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على المولد النبوي 2026؟', a: '24 أغسطس 2026م — 12 ربيع الأول 1448 هـ.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على ليلة القدر 2026؟', a: 'أرجحها ليلة 27 رمضان الموافقة تقريباً 17 مارس 2026.' },
  ...
  },
  {
    ...
    faqItems: [
      { q: 'كم باقي على الإسراء والمعراج 2026؟', a: 'يُحسب تلقائياً من 27 رجب 1447.' },
  ...
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على النصف من شعبان 2026؟', a: 'يُحسب تلقائياً من 15 شعبان 1447.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على أول ذو الحجة 2026؟', a: 'يُحسب تلقائياً من AlAdhan API.' }],
  },
];
...
export const SEASONAL_EVENTS = [
  {
    ...
    faqItems: [{ q: 'كم باقي على رأس السنة 2027؟', a: '1 يناير 2027.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على الصيف 2026؟', a: '21 يونيو 2026.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على الشتاء 2026؟', a: '21 ديسمبر 2026.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على الربيع 2026؟', a: '20 مارس 2026.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على الخريف 2026؟', a: '22 سبتمبر 2026.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على عطلة الربيع 2026؟', a: '~29 مارس 2026. قد يتغير بقرار رسمي.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على الإجازة الصيفية 2026؟', a: '~يونيو 2026. التواريخ تقديرية حسب الدولة.' }],
  },
  {
    ...
    faqItems: [{ q: 'كم باقي على الدراسة 2026؟', a: '~سبتمبر 2026. يتفاوت بحسب كل دولة.' }],
  },
];
...
export const COUNTRIES_EVENTS = [
  {
    ...
    events: [
      ...
      {
        id: 'citizen-account-sa', slug: 'citizen-account-saudi', name: 'حساب المواطن (السعودية)', type: 'monthly', day: 10, category: 'support',
      ...
      {
        id: 'social-security-sa', slug: 'social-security-saudi', name: 'الضمان الاجتماعي المطور (السعودية)', type: 'monthly', day: 1, category: 'support',
