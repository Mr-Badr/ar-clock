...
export function buildTimeNowKeywords({
  ...
  const keywords = [
    ...
    ...locationNames.flatMap((name) => [
      ...
      `كم الساعة في ${name}`,
      `الساعة كم في ${name}`,
      `الساعة كم الان في ${name}`,
      `الساعة كم الآن في ${name}`,
      `الوقت في ${name} الان`,
      `الوقت في ${name} الآن`,
      `توقيت ${name} الان`,
      `توقيت ${name} الآن`,
      `كم الساعة الان في ${name} اليوم`,
      `كم الساعة الآن في ${name} اليوم`,
      `الوقت الحالي في ${name}`,
      `التاريخ اليوم في ${name}`,
      `التاريخ والوقت في ${name}`,
...
export function buildPrayerKeywords({
  ...
  const keywords = [
    ...
    ...locationNames.flatMap((name) => [
      ...
      `صلاة المغرب في ${name}`,
      `صلاة العشاء في ${name}`,
      `متى صلاة الفجر في ${name}`,
      `متى صلاة المغرب في ${name}`,
      `إمساكية ${name}`,
      `جدول الصلاة في ${name}`,
    ]),
    ...englishNames.flatMap((name) => [
...
export function buildTimeDifferenceKeywords({
  ...
  if (fromCityAr && toCityAr) {
    keywords.push(
      ...
      `من يسبق الان ${fromCityAr} أم ${toCityAr}`,
      `من يسبق الآن ${fromCityAr} أم ${toCityAr}`,
      `تحويل الوقت من ${fromCityAr} إلى ${toCityAr}`,
      `الساعة الان في ${toCityAr} مقارنة بـ ${fromCityAr}`,
  ...
  for (const fromCountryName of fromCountryNames) {
    for (const toCountryName of toCountryNames) {
      keywords.push(
        ...
        `من يسبق الان ${fromCountryName} أم ${toCountryName}`,
        `من يسبق الآن ${fromCountryName} أم ${toCountryName}`,
        `تحويل الوقت بين ${fromCountryName} و${toCountryName}`,
        `الوقت الان بين ${fromCountryName} و${toCountryName}`,
