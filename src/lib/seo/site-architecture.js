...
export const ROOT_SITEMAP_ROUTES = Object.freeze(dedupeRoutes([
  ...
  { path: '/holidays/country/kuwait', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/uae', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/qatar', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/bahrain', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/oman', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/germany', priority: 0.88, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/sweden', priority: 0.88, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/morocco', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/france', priority: 0.88, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/turkey', priority: 0.88, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/usa', priority: 0.88, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/canada', priority: 0.88, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/algeria', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/tunisia', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/jordan', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/egypt', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/iraq', priority: 0.9, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/libya', priority: 0.85, changeFrequency: 'daily', websitePart: true },
  { path: '/holidays/country/syria', priority: 0.85, changeFrequency: 'daily', websitePart: true },
  ...
  { path: '/date/hijri-months', priority: 0.87, changeFrequency: 'daily', websitePart: true },
...
const FEATURE_ROUTE_FAMILIES = Object.freeze([
  ...
  {
    id: 'imsakiya',
    label: 'Ramadan imsakiya',
    exactPaths: ['/imsakiya'],
    prefixPaths: ['/imsakiya/'],
    crawlScope: 'priority-countries-and-cities',
  },
  {
    id: 'time-difference',
