...
export const ROOT_SITEMAP_ROUTES = Object.freeze(dedupeRoutes([
  ...
  { path: '/date/gregorian-to-hijri', priority: 0.86, changeFrequency: 'weekly', websitePart: false },
  { path: '/date/hijri-to-gregorian', priority: 0.86, changeFrequency: 'weekly', websitePart: false },
  { path: '/date/calendar', priority: 0.82, changeFrequency: 'weekly', websitePart: false },
  { path: '/date/calendar/hijri', priority: 0.82, changeFrequency: 'weekly', websitePart: false },
  { path: '/date/country', priority: 0.8, changeFrequency: 'weekly', websitePart: false },
