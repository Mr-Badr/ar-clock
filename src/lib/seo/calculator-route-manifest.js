...
export const STATIC_CALCULATOR_SEO_ROUTES = Object.freeze([
  ...
  { path: '/calculators/domestic-worker-cost', priority: 0.9, changeFrequency: 'monthly', websitePart: true },
  { path: '/calculators/iddah', priority: 0.9, changeFrequency: 'yearly', websitePart: true },
  { path: '/calculators/date-add-subtract', priority: 0.88, changeFrequency: 'yearly', websitePart: true },
  { path: '/calculators/aqiqah', priority: 0.88, changeFrequency: 'yearly', websitePart: true },
  { path: '/calculators/wasiyya', priority: 0.88, changeFrequency: 'yearly', websitePart: true },
  { path: '/calculators/nafaqah', priority: 0.9, changeFrequency: 'yearly', websitePart: true },
  { path: '/calculators/weaning-schedule', priority: 0.9, changeFrequency: 'yearly', websitePart: true },
  ...
  { path: '/calculators/sick-leave', priority: 0.85, changeFrequency: 'weekly', websitePart: true },
  { path: '/calculators/working-days', priority: 0.85, changeFrequency: 'weekly', websitePart: true },
  { path: '/calculators/weighted-grade', priority: 0.85, changeFrequency: 'weekly', websitePart: true },
  { path: '/calculators/margin-markup', priority: 0.85, changeFrequency: 'weekly', websitePart: true },
