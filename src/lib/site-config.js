...
export const SITE_KEYWORDS = Array.from(new Set([
  ...
  ...SITE_LEGACY_BRANDS,
  // Short
  'الوقت', 'الساعة', 'مواقيت', 'أوقات', 'الصلاة', 'الأذان', 'توقيت', 'التاريخ',
  'هجري', 'ميلادي', 'التقويم', 'المناسبات', 'اقتصاد', 'فوركس', 'بورصة',
  
  // Medium
  'الوقت الان', 'الساعة الان', 'كم الساعة', 'مواقيت الصلاة اليوم', 'أوقات الأذان',
  'دليل اتجاه القبلة', 'فرق التوقيت', 'حاسبة التوقيت', 'تحويل التاريخ',
  'تاريخ اليوم هجري', 'التقويم الهجري 1446', 'تحويل التاريخ الهجري والميلادي',
  'أوقات التداول العالمية', 'جلسات الفوركس', 'السوق المفتوح', 'العد التنازلي', 
  
  // Long
  'كم الساعة الان في مدينتي ووقت الصلاة القادم', 'مواقيت الصلاة الدقيقة واتجاه القبلة لجميع المدن',
  'معرفة فرق التوقيت بين الدول وحاسبة التوقيت العالمي', 'تاريخ اليوم بالهجري والميلادي مع التقويم الشامل',
  'أداة تحويل التاريخ من هجري إلى ميلادي والعكس بسهولة', 'العد التنازلي لأهم المناسبات والأعياد والإجازات الرسمية',
  'تتبع حركة الأسواق العالمية ومواعيد افتتاح البورصة', 'ساعة التداول لمعرفة جلسات الفوركس والذهب اللحظية',
