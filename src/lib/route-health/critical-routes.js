...
export const CRITICAL_ROUTE_PROBES = Object.freeze([
  ...
  },
  {
    ...
    path: '/tools/gulf-finance/end-of-service-benefits',
    label: 'Finance calculator',
    minimumBodyBytes: 10000,
    requiredMarkers: ['حاسبة مكافأة نهاية الخدمة'],
    forbiddenMarkers: ['content="noindex'],
  },
  {
    id: 'age-calculator',
  ...
  },
  {
    ...
    path: '/tools/gulf-finance/article-77-compensation',
    label: 'Article 77 compensation calculator',
    minimumBodyBytes: 10000,
    requiredMarkers: ['حاسبة تعويض المادة 77'],
    forbiddenMarkers: ['content="noindex'],
  },
  {
    id: 'traffic-fine-calculator',
    path: '/tools/gulf-finance/traffic-fine-discount',
    label: 'Traffic fine discount calculator',
    minimumBodyBytes: 10000,
    requiredMarkers: ['خصم وتقسيط المخالفات المرورية'],
    forbiddenMarkers: ['content="noindex'],
  },
  {
    ...
    minimumBodyBytes: 10000,
    requiredMarkers: ['حاسبات النوم الذكي', '/tools/sleep/bedtime'],
    forbiddenMarkers: ['content="noindex'],
  },
  {
    id: 'cement-calculator',
    path: '/tools/construction/cement',
